...
<head>
	...
	<meta name="description" content="Add Movie Actor Relation">
...
<body>
	<h2>Add New Movie Actor Relation:<br></h2>
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method = "GET">
		<table cellspacing="10">
			...
			<tr>
				<td>Actor<span style="color:red">*</span>:</td>	
				<td>
					<select name="actor" required>
						<?php
							...
							// Populate Actor Dropdown menu
							$query_str = "SELECT id, last, first, dob FROM Actor";
							$result = mysql_query($query_str, $db_connection);
							if (mysql_num_rows($result) > 0){
								while ($row = mysql_fetch_row($result)) {
						            echo "<option value=\"$row[0]\">";
			...
			<tr>
				...
				<td>
					<input type="text" name="role" size="50" maxlength="50" required/>
				</td>
			</tr>
		</table>
